...
public class Home extends JFrame{
    ...
    public Home(String username) {
        super("TOURS AND TRAVEL MANAGEMENT SYSTEM");
	...
	NewLabel.setBounds(0, 0, 1950, 1000); 
        ...
        JLabel l1 = new JLabel("TOURS AND TRAVEL MANAGEMENT SYSTEM");
        // heading added
        JLabel l2 = new JLabel("Prepared By:-");
        
        // team members details
        
        JLabel l3 = new JLabel("1.RAVI RANJAN YADAV");
        JLabel l4 = new JLabel("2.RAMESH KUMAR SINGH");
        JLabel l5=  new JLabel("3.DIBYENDU CHATTORAJ");
	...
	l5.setForeground(Color.white);
        l1.setFont(new Font("Tahoma", Font.CENTER_BASELINE, 50));
        l2.setFont(new Font("Tahoma", Font.ITALIC, 45));
        l3.setFont(new Font("Tahoma", Font.ITALIC, 40));
        l4.setFont(new Font("Tahoma", Font.ITALIC, 40));
        l5.setFont(new Font("Tahoma", Font.ITALIC, 40));
	l1.setBounds(200, 60, 1800, 100);
	l2.setBounds(950, 390, 1000, 100);
	l3.setBounds(1000, 450, 1000, 100);
	l4.setBounds(1000, 490, 1000, 100);
	l5.setBounds(1000, 530, 1000, 100);
	NewLabel.add(l1);
	NewLabel.add(l2);
	NewLabel.add(l3);
	NewLabel.add(l5);
